  ...
  ppl: {
    ...
    schedule: [
      ...
      },
      {
        ...
        label: 'Mardi',
        focus: 'Pull A',
        muscleGroups: ['dos', 'biceps', 'trapèzes'],
        restDay: false,
      },
      {
        dayOfWeek: 3,
        label: 'Mercredi',
        focus: 'Jambes A',
        muscleGroups: ['quadriceps', 'ischio', 'mollets', 'fessiers'],
        restDay: false,
      },
      {
        dayOfWeek: 4,
  ...
  upper_lower: {
    ...
    schedule: [
      ...
      },
      {
        dayOfWeek: 2,
        label: 'Mardi',
        focus: 'Bas du corps A',
        muscleGroups: ['quadriceps', 'ischio', 'fessiers', 'mollets'],
        restDay: false,
      },
